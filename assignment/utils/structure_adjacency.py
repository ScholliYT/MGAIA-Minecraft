    ...
    empty_space_air: StructureAdjacency(
        ...
        x_plus=[
            *all_rotations(empty_space_air),
            ...
            StructureRotation(brickhouse_entrance_stairs, 1).rotate(3), # from brickhouse_entrance_stairs.x_minus
            StructureRotation(brickhouse_entrance_stairs, 1).rotate(2), # from brickhouse_entrance_stairs.z_minus
            ...
            StructureRotation(brickhouse_roofhouse_corner_stairs, 1).rotate(3), # from brickhouse_roofhouse_corner_stairs.x_minus
            StructureRotation(brickhouse_roofhouse_corner_stairs, 1).rotate(2), # from brickhouse_roofhouse_corner_stairs.z_minus
        ...
        x_minus=[
            *all_rotations(empty_space_air),
            ...
            StructureRotation(brickhouse_entrance_stairs, 3).rotate(3), # from brickhouse_entrance_stairs.x_minus
            StructureRotation(brickhouse_entrance_stairs, 3).rotate(2), # from brickhouse_entrance_stairs.z_minus
            ...
            StructureRotation(brickhouse_roofhouse_corner_stairs, 3).rotate(3), # from brickhouse_roofhouse_corner_stairs.x_minus
            StructureRotation(brickhouse_roofhouse_corner_stairs, 3).rotate(2), # from brickhouse_roofhouse_corner_stairs.z_minus
        ...
        z_plus=[
            *all_rotations(empty_space_air),
            ...
            StructureRotation(brickhouse_entrance_stairs, 2).rotate(3), # from brickhouse_entrance_stairs.x_minus
            StructureRotation(brickhouse_entrance_stairs, 2).rotate(2), # from brickhouse_entrance_stairs.z_minus
            ...
            StructureRotation(brickhouse_roofhouse_corner_stairs, 2).rotate(3), # from brickhouse_roofhouse_corner_stairs.x_minus
            StructureRotation(brickhouse_roofhouse_corner_stairs, 2).rotate(2), # from brickhouse_roofhouse_corner_stairs.z_minus
        ...
        z_minus=[
            *all_rotations(empty_space_air),
            ...
            StructureRotation(brickhouse_entrance_stairs, 0).rotate(3), # from brickhouse_entrance_stairs.x_minus
            StructureRotation(brickhouse_entrance_stairs, 0).rotate(2), # from brickhouse_entrance_stairs.z_minus
            ...
            StructureRotation(brickhouse_roofhouse_corner_stairs, 0).rotate(3), # from brickhouse_roofhouse_corner_stairs.x_minus
            StructureRotation(brickhouse_roofhouse_corner_stairs, 0).rotate(2), # from brickhouse_roofhouse_corner_stairs.z_minus
